...
\begin{frame}{Feature noise -- analisi}
  \begin{itemize}
    ...
    \item La NN Base, senza vincoli, si adatta al rumore $\Rightarrow$ peggiora
          sui campioni nuovi.
...
\begin{frame}{Feature noise -- evidenze grafiche}
  ...
  {\scriptsize NN Base, matrici di confusione a $10/25/40\%$: gli adroni vengono classificati sempre più spesso come gamma.}
\end{frame}
