...
\begin{frame}{Feature noise localizzato -- analisi}
  \begin{itemize}
    \item Intensità fissa con $\sigma=0{,}35$, ma colpisce solo le feature più
          importanti: top-1 (\feat{fAlpha}) $\to$ top-3 $\to$ top-5.
    \item Degrado comunque lieve: al $40\%$ tutti sopra l'$83\%$.
    \item Rimane assimetria: recall degli adroni nelle rete Base a $0{,}67$, in quella Pro a $0{,}75$.
  \end{itemize}
  \vfill
  Il rumore degrada l'informazione ma non la cancella:
